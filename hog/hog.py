...
def announce_lead_changes(previous_leader=None):
    ...
    def say(score0, score1):
        ...
        if leader != None and leader != previous_leader:
            difference = abs(score0 - score1)
            print('Player', leader, 'takes the lead by', difference)
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def announce_player(score0, score1):
        incresement = 0
        ...
        if who == 0:
            incresement = score0 - previous_score
            new_score = score0
        else:
            incresement = score1 - previous_score
            new_score = score1
        if incresement > previous_high:
            print(incresement, "point(s)! That's the biggest gain yet for Player", who)
            new_high = incresement
...
def make_averaged(fn, num_samples=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def get_averaged(num_rolls = 1, dice = fn):
        s = 0
        for _ in range(num_samples):
            s += roll_dice(num_rolls, dice)
        s /= num_samples
        return s
    return get_averaged
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for i in range(1, 11):
        ...
        score /= num_samples
        """
        score = make_averaged(dice, num_samples)(i)
        if score > max_score:
            max_score = score
            max_rolls = i
    return max_rolls
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    """
    # BEGIN PROBLEM 12
    rolls = swap_strategy(score, opponent_score, 6, 1)
    incresement = free_bacon(opponent_score)
    new_score = incresement + score
    if rolls == 0 or new_score >= 100:
        rolls = 0
