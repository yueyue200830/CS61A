...
; expect do_sum
(do_sum 2)
; expect (lambda (y) (begin (define x (+ x y)) x))
(define sum_three (do_sum 3))
; expect sum_three
(sum_three 5)
; expect 8
(define x 2)
...
; expect get_sum
(get_sum (lambda (a) (- a)) divide -5)
; expect 5
(get_sum (lambda (a) (- a)) divide 6)
; expect 1.1666666666666667
(get_sum (lambda (a) (- a)) divide 301)
; expect 301

(or #f (and #t ((lambda (x) (+ x 1)) -1) 3))
; expect 3
...
(quote (lambda a (+ (* a 2) 1 )))
; expect (lambda a (+ (* a 2) 1))
